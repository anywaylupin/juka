...
export const cardGroups = sqliteTable(
  'card_groups',
  {
...
export const stories = sqliteTable(
  ...
  (table) => [index('stories_user_idx').on(table.userId, table.id)]
);

export const storyCards = sqliteTable(
  'story_cards',
  {
  ...
  (table) => [uniqueIndex('story_cards_pair_idx').on(table.storyId, table.cardId)]
);
